...
clipboard-daemon: main.o clipboard-daemon.o selection-data-list.o
	$(CC) $(CFLAGS) main.o clipboard-daemon.o selection-data-list.o -o clipboard-daemon `pkg-config --libs gtk+-3.0`

main.o: main.c
	$(CC) $(CFLAGS) -c main.c -o main.o `pkg-config --cflags gtk+-3.0`

clipboard-daemon.o: clipboard-daemon.c clipboard-daemon.h
	$(CC) $(CFLAGS) -c clipboard-daemon.c -o clipboard-daemon.o `pkg-config --cflags gtk+-3.0`

selection-data-list.o: selection-data-list.c selection-data-list.h
	$(CC) $(CFLAGS) -c selection-data-list.c -o selection-data-list.o `pkg-config --cflags gtk+-3.0`
